...
const initIpc = () => {
  electron__WEBPACK_IMPORTED_MODULE_3__.ipcMain.on("need-app-path", (event, arg) => {
    event.reply("app-path", electron__WEBPACK_IMPORTED_MODULE_3__.app.getAppPath());
  });
  electron__WEBPACK_IMPORTED_MODULE_3__.ipcMain.on("open-external-link", (event, href) => {
    electron__WEBPACK_IMPORTED_MODULE_3__.shell.openExternal(href);
  });
  electron__WEBPACK_IMPORTED_MODULE_3__.ipcMain.handle('test-action', async (event, arg) => {
...
electron__WEBPACK_IMPORTED_MODULE_3__.app.on('will-quit', function () {
  electron__WEBPACK_IMPORTED_MODULE_3__.globalShortcut.unregisterAll();
});
})();
